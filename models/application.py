...
class MyModelName(models.Model):
    ...
    fa_name = fields.Char(string="Father's Name", required=True)
    ma_name = fields.Char(string="Mother's Name", required=True)

    # student_id= fields.Many2one(comodel_name="school.student")
    student_id = fields.Many2many(comodel_name="school.student")
...
#
#         view = self.env.ref('school_module.my_model_name_wizard_form_view')
#         if view:
#             return {
